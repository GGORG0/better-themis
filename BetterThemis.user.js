        ...
        runIfSelectorParent(test, "td:nth-child(2) > img", (el) => {
          ...
          switch (srcSplit[srcSplit.length - 1]){
            ...
            case "testsegv.png":
              ...
              break;
            case "testevil.png":
              newSrc = "https://github.com/GGORG0/better-themis/blob/master/icons/problemIllegalSyscall.png?raw=true";
              break;
            default:
              newSrc = el.src;
              break;
        ...
        switch (statusBall.className){
          ...
          case "status-fail": {
            switch(submission.querySelector(".problem-status-res").textContent){
              ...
              case "illegal syscall": {
                statusIcon.src = "https://github.com/GGORG0/better-themis/blob/master/icons/problemIllegalSyscall.png?raw=true";
                break;
              }
            }
            break;
...
(function() {
  ...
  #content {
    ...
    display: flex;
    flex-direction: ${document.querySelector("#content > #ranks-container") || document.querySelector("#content > #status-table") ? "column" : "row"};
    justify-content: center;
    align-items: center;
    `}
    background: none;
